...
| P4 | REALIZED-BY-P2 + validator: P2's uniform isWorld path already migrated every world-classified surface (journey exercised scenes/layers/takes/characters/notes end-to-end); P4 lands the birth-flag discriminator (world creates carry space:world, chrome space:screen — no mixed authority at birth) + the defaultPlacement audit conclusion (world surfaces place via the world cascade; defaultPlacement is screen-chrome-only) | tests/frontend/freeform-window-manager.test.js | P4 discriminator green | revert test |
